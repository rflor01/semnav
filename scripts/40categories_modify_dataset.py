...
def txt_updater_40categories(ruta_fichero, diccionario):
    ...
    with open(ruta_fichero, 'r') as file:
        ...
        for linea in lineas[1:]:
            ...
            id_categoria, color = diccionario.get(categoria, [0, "000000"])
            partes[0] = str(id_categoria)
            partes[1] = color
            partes[2] = class_names[id_categoria].replace("'",'"')
...
def modify_scene_colors(scene_txt_path, global_dictionary,images_directory):
    ...
    with open(scene_txt_path, 'r') as file:
        ...
        for linea in lineas[1:]:
            ...
            categoria = partes[2].replace('"', '')
            color = partes[1]
            new_color = global_dictionary.get(categoria,[0, "000000"])[1]
            print("Color", color)
...
scene_dataset_path = "/home/rafa/rafarepos/semnav/data/40categories_datasets/hm3d"
log_txt = "modify_dataset_log_40categories.txt"
...
for semantic_directory in semantic_directories:
    ...
    global_dictionary_txt_path = "/home/rafa/rafarepos/semnav/scripts/last_global_dictionary_40categories.txt"
    ...
    txt_updater_40categories(scene_txt_path,global_dictionary)
